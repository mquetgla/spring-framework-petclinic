...
INSERT INTO visits (id, pet_id, visit_date, description, vet_id) VALUES (1, 7, '2010-03-04', 'rabies shot', 4) ON CONFLICT DO NOTHING;
INSERT INTO visits (id, pet_id, visit_date, description, vet_id) VALUES (2, 8, '2011-03-04', 'rabies shot', 2) ON CONFLICT DO NOTHING;
INSERT INTO visits (id, pet_id, visit_date, description, vet_id) VALUES (3, 8, '2009-06-04', 'neutered', 3) ON CONFLICT DO NOTHING;
INSERT INTO visits (id, pet_id, visit_date, description, vet_id) VALUES (4, 7, '2008-09-04', 'spayed', NULL) ON CONFLICT DO NOTHING;

INSERT INTO weight_records (id, weight, measure_date, pet_id) VALUES (1, 4.20, '2012-09-07', 1) ON CONFLICT DO NOTHING;
INSERT INTO weight_records (id, weight, measure_date, pet_id) VALUES (2, 4.35, '2013-03-07', 1) ON CONFLICT DO NOTHING;
INSERT INTO weight_records (id, weight, measure_date, pet_id) VALUES (3, 4.50, '2013-09-07', 1) ON CONFLICT DO NOTHING;
INSERT INTO weight_records (id, weight, measure_date, pet_id) VALUES (4, 7.80, '2012-04-17', 3) ON CONFLICT DO NOTHING;
INSERT INTO weight_records (id, weight, measure_date, pet_id) VALUES (5, 8.00, '2012-10-17', 3) ON CONFLICT DO NOTHING;
INSERT INTO weight_records (id, weight, measure_date, pet_id) VALUES (6, 8.20, '2013-04-17', 3) ON CONFLICT DO NOTHING;
